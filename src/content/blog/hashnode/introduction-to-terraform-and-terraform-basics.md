...
![Introduction to Terraform and Terraform Basics](/_next/image?url=https%3A%2F%2Fcdn.hashnode.com%2Fres%2Fhashnode%2Fimage%2Fupload%2Fv1685952704721%2F6e35344b-d0fb-467e-8c78-d7b6ef94a5cd.jpeg&w=3840&q=75)
...
[Introduction](#heading-introduction)[What is IAC?](#heading-what-is-iac)[What is Terraform?](#heading-what-is-terraform)[How does Terraform simplify infrastructure provisioning?](#heading-how-does-terraform-simplify-infrastructure-provisioning)[Installing Terraform](#heading-installing-terraform)[Important Terminologies in Terraform](#heading-important-terminologies-in-terraform)[Provider](#heading-provider)[Resource](#heading-resource)[Variables](#heading-variables)[Modules](#heading-modules)[State](#heading-state)[Setting up the Environment for AWS, Azure, or GCP:](#heading-setting-up-the-environment-for-aws-azure-or-gcp)[AWS](#heading-aws)[Azure](#heading-azure)[GCP](#heading-gcp)[Using Environmental Variables for Secret Access Key](#heading-using-environmental-variables-for-secret-access-key)[Using HashiCorp Terraform Vault:](#heading-using-hashicorp-terraform-vault)[Conclusion](#heading-conclusion)
