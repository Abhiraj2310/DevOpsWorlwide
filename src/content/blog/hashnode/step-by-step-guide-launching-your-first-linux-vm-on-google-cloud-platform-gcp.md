...
tags: ["Hashnode","devops","gcp","compute-engine","cloud"]
...
![Step-by-Step Guide: Launching Your First Linux VM on Google Cloud Platform (GCP)](/_next/image?url=https%3A%2F%2Fcdn.hashnode.com%2Fres%2Fhashnode%2Fimage%2Fupload%2Fv1685454605418%2F08b41739-2ba4-4143-be4e-e5b4b68041d3.jpeg&w=3840&q=75)
...
[Introduction](#heading-introduction)[Steps](#heading-steps)[Step 1: Create a GCP Account:](#heading-step-1-create-a-gcp-account)[Step 2: Set Up a New Project:](#heading-step-2-set-up-a-new-project)[Step 3: Enable Compute Engine API:](#heading-step-3-enable-compute-engine-api)[Step 4: Create a VM Instance:](#heading-step-4-create-a-vm-instance)[Step 5: Connect to the Linux VM:](#heading-step-5-connect-to-the-linux-vm)[Step 6: Explore and Customize Your Linux VM:](#heading-step-6-explore-and-customize-your-linux-vm)[Step 7: Deleting a VM on Google Cloud Platform (GCP):](#heading-step-7-deleting-a-vm-on-google-cloud-platform-gcp)[Conclusion](#heading-conclusion)
