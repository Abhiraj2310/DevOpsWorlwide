...
![Project: Provisioning Kubernetes Cluster on AWS with Terraform](/_next/image?url=https%3A%2F%2Fcdn.hashnode.com%2Fres%2Fhashnode%2Fimage%2Fupload%2Fv1684333451602%2F57b906a2-579d-435a-88c7-bf4327603ea6.jpeg&w=3840&q=75)
...
[Prerequisites](#heading-prerequisites)[Introduction](#heading-introduction)[What is main.tf file?](#heading-what-is-maintf-file)[Project Steps:](#heading-project-steps)[Step 1: Create an IAM user](#heading-step-1-create-an-iam-user)[Step 2: Write your main.tf file](#heading-step-2-write-your-maintf-file)[Block 1: AWS Provider Block](#heading-block-1-aws-provider-block)[Block 2: AWS VPC Resource Block](#heading-block-2-aws-vpc-resource-block)[Block 3: AWS Subnet Resource Block (Public Subnet)](#heading-block-3-aws-subnet-resource-block-public-subnet)[Block 4:AWS Subnet Resource Block (Private Subnet)](#heading-block-4aws-subnet-resource-block-private-subnet)[Block 5:AWS Security Group Resource Block](#heading-block-5aws-security-group-resource-block)[Block 6:AWS EC2 Instance Resource Block (Master Node)](#heading-block-6aws-ec2-instance-resource-block-master-node)[Block 7:AWS EC2 Instance Resource Block (Worker Node)](#heading-block-7aws-ec2-instance-resource-block-worker-node)[Step 3: Initialize the working directory](#heading-step-3-initialize-the-working-directory)[Step 4: Generate an execution plan](#heading-step-4-generate-an-execution-plan)[Step 5: Apply the changes](#heading-step-5-apply-the-changes)[Step 6: Confirm the changes](#heading-step-6-confirm-the-changes)[Output:](#heading-output)[Conclusion:](#heading-conclusion)
