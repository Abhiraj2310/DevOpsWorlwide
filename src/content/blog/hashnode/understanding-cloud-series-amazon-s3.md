...
PublishedJuly 15, 2023•11 min read•[**View as Markdown](/understanding-cloud-series-amazon-s3.md)

![Understanding Cloud Series: Amazon S3](/_next/image?url=https%3A%2F%2Fcdn.hashnode.com%2Fres%2Fhashnode%2Fimage%2Fupload%2Fv1689441125522%2Fdbb7805a-02ec-41c3-8a0d-26ec54d7dbc7.png&w=3840&q=75)
...
[Introduction](#heading-introduction)[S3 Overview](#heading-s3-overview)[S3 Hands-On:](#heading-s3-hands-on)[a. Create an S3 Bucket:](#heading-a-create-an-s3-bucket)[b. Configure Bucket Properties:](#heading-b-configure-bucket-properties)[c. Upload Objects:](#heading-c-upload-objects)[d. Access Control:](#heading-d-access-control)[e. Retrieve Objects:](#heading-e-retrieve-objects)[Security:](#heading-security)[a. Access Control:](#heading-a-access-control)[b. Server-Side Encryption:](#heading-b-server-side-encryption)[c. Data Protection:](#heading-c-data-protection)[Static Web Hosting:](#heading-static-web-hosting)[a. Configure Bucket for Website Hosting:](#heading-a-configure-bucket-for-website-hosting)[b. Set Permissions:](#heading-b-set-permissions)[c. Configure DNS and Domain:](#heading-c-configure-dns-and-domain)[d. Test and Publish:](#heading-d-test-and-publish)[Versioning and Replication:](#heading-versioning-and-replication)[a. Versioning:](#heading-a-versioning)[b. Replication:](#heading-b-replication)[Detailed Explanation of Storage Classes:](#heading-detailed-explanation-of-storage-classes)[a. S3 Standard:](#heading-a-s3-standard)[b. S3 Intelligent-Tiering:](#heading-b-s3-intelligent-tiering)[c. S3 Standard-IA (Infrequent Access):](#heading-c-s3-standard-ia-infrequent-access)[d. S3 One Zone-IA:](#heading-d-s3-one-zone-ia)[e. Glacier:](#heading-e-glacier)[f. Glacier Deep Archive:](#heading-f-glacier-deep-archive)[Encryption:](#heading-encryption)[a. Server-Side Encryption:](#heading-a-server-side-encryption)[b. Client-Side Encryption:](#heading-b-client-side-encryption)[c. AWS Key Management Service (KMS):](#heading-c-aws-key-management-service-kms)[Shared Responsibilities Model:](#heading-shared-responsibilities-model)[AWS Snow:](#heading-aws-snow)[Storage Gateway:](#heading-storage-gateway)[a. File Gateway:](#heading-a-file-gateway)[b. Volume Gateway:](#heading-b-volume-gateway)[c. Tape Gateway:](#heading-c-tape-gateway)[Key Points for AWS Certified Cloud Practitioner (CCP) exam preparation:](#heading-key-points-for-aws-certified-cloud-practitioner-ccp-exam-preparation)[Conclusion](#heading-conclusion)
