...
PublishedJuly 16, 2023•24 min read•[**View as Markdown](/understanding-cloud-series-day-7-part-a.md)

![Understanding Cloud Series: Day 7 Part A](/_next/image?url=https%3A%2F%2Fcdn.hashnode.com%2Fres%2Fhashnode%2Fimage%2Fupload%2Fv1689501913618%2Faa6a6dd3-bcfa-474a-9a08-f1b004da9bed.png&w=3840&q=75)
...
[Introduction](#heading-introduction)[Virtual Private Cloud (VPC)](#heading-virtual-private-cloud-vpc)[AWS Wavelength](#heading-aws-wavelength)[Amazon CloudFront](#heading-amazon-cloudfront)[AWS Amplify](#heading-aws-amplify)[AWS Backup](#heading-aws-backup)[Disaster Recovery Solution (DRS)](#heading-disaster-recovery-solution-drs)[Databases](#heading-databases)[Key points to help you study for the AWS Certified Cloud Practitioner (CCP) exam:](#heading-key-points-to-help-you-study-for-the-aws-certified-cloud-practitioner-ccp-exam)[AWS Architecture:](#heading-aws-architecture)[Virtual Private Cloud (VPC):](#heading-virtual-private-cloud-vpc-1)[AWS Wavelength:](#heading-aws-wavelength-1)[Amazon CloudFront:](#heading-amazon-cloudfront-1)[AWS Amplify:](#heading-aws-amplify-1)[AWS Backup:](#heading-aws-backup-1)[Disaster Recovery Solution (DRS):](#heading-disaster-recovery-solution-drs-1)[Databases:](#heading-databases-1)[Conclusion](#heading-conclusion)
